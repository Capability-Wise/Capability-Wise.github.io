...
<div class="header-2">
	<div class="page-header header-filter" style="background-image: url('assets/img/office2.jpg');">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					<h1 class="title">Digital Transformation is more than new websites <br />and APIs..</h1>

					<h4> Digital transformation is about reimagining the way you deliver services to your customers <br />and establishing the right capabilities to consistently exceed their expectations.</h4>

					<h3>Anything short of that is just digitisation. </h3>
...
<div class="main main-raised" id="consultingServices">
	<div class="section">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					<h2 class="title">Strategy and Advisory Services</h2>
					<h4 class="description">Capability Wise can assist with all your digital transformation needs. We provide consulting and advisory services across the full transformation lifecycle from helping you establish a clear strategy, through execution, and ultimately establishment of the appropriate capabilities to sustain your market advantage. </h4>
				</div>
			</div>
...
<div class="main" id="technologyServices">
<br/><br/>
	<div class="section-dark">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					<h2 class="title">Technology Consulting Services</h2>
					<h4 class="description">Unlike other technology services companies we are not all things to all customers.<br /><br />We have specialised on two niche offerings that enable us to provide leading edge solutions to our customers at the best possible price point.</h4>
				</div>
			</div>
			<div class="features-1">
				<div class="row">
					<div class="col-md-5 col-md-offset-1" id="blockchainServices">
						<div class="info">
							<div class="icon icon-rose">
...
<!-- ********* START TEAM ********* -->
<div class="cd-section" id="execTeam">

<div class="team-1" id="team-1">
<div class="container">
<div class="row">
<div class="col-md-8 col-md-offset-2 text-center">
<h2 class="title">Our Executive Team</h2>
...
<a href="#matt">
<img class="img" src="assets/img/faces/matt.jpg" />
</a>
</div>
<div class="card-content">
<h4 class="card-title">Matt Lewis</h4>
<h6 class="category text-muted">Managing Director</h6>
<p class="card-description">
Matt is an experienced Management Consultant with an extensive background in the delivery of complex ICT programmes.
</p>
<div class="footer">
<!--<a href="#matt" class="btn btn-just-icon btn-simple btn-twitter"><i class="fa fa-twitter"></i></a>-->
<a href="https://www.linkedin.com/in/matt-lewis-b8a9845a/" class="btn btn-just-icon btn-simple btn-linkedin"><i class="fa fa-linkedin"></i></a>
</div>
</div>
</div>
</div>
...
<div class="card-avatar">
<a href="#joanna">
<img class="img" src="assets/img/faces/jo.jpg" />
</a>
</div>
<div class="card-content">
<h4 class="card-title">Joanna Lewis</h4>
<h6 class="category text-muted">Director - Stakeholder Engagement &amp; Change</h6>
<p class="card-description">
Joanna is an experienced Change Manager with a passion for strategic engagement and exceptional user experiences.
</p>
<div class="footer">
<!--<a href="#joanna" class="btn btn-just-icon btn-simple btn-twitter"><i class="fa fa-twitter"></i></a>-->
<a href="https://www.linkedin.com/in/joanna-lewis-90171952/" class="btn btn-just-icon btn-simple btn-linkedin"><i class="fa fa-linkedin"></i></a>
</div>
</div>
</div>
</div>
...
<!-- ********* TESTIMONIALS ********* -->
<div class="testimonials-2 section-dark" id="clientReferences">
<div class="container">
<div class="row">
<div class="col-md-8 col-md-offset-2 text-center">
<h2 class="title">Our Clients Love Us</h2>
<h5 class="description">You need more information? Check what others are saying about us:</h5>
</div>
</div>
...
"Capability Wise Pty Ltd provided the ATO with support and technical guidance in developing the paper ‘Unlocking the Digital Economy – A guide to Implementing Application Programming Interfaces in Government’. This paper was subsequently published by the Organisation for Economic Co-operation and Development (OECD) in 2019."
</h5>
<h5 class="card-description">
...
<h4 class="card-title">John Dardo</h4>
<h6 class="category text-muted">Chief Digital Officer & Deputy Commissioner Digital Delivery, Australian Taxation Office</h6>
<div class="footer">
...
<br />
<h4 class="card-title">Isaac Naughton</h4>
<h6 class="category text-muted">Basware</h6>
<div class="footer">
<i class="material-icons text-warning">star</i>
<i class="material-icons text-warning">star</i>
<i class="material-icons text-warning">star</i>
...
<div class="card-content">
<h5 class="card-description">
"Capability Wise strengths are that they take the time to understand the business outcome, explain the options clearly, focus on people, deliver what they promise and are easy to work with."
</h5>
<h5 class="card-description">
"I can’t recommend them highly enough."
</h5>
<h4 class="card-title">John McAlister</h4>
<h6 class="category text-muted">Assistant Commissioner (former) - Australian Taxation Office</h6>
<div class="footer">
<i class="material-icons text-warning">star</i>
<i class="material-icons text-warning">star</i>
<i class="material-icons text-warning">star</i>
...
<!-- ********* END TESTIMONIALS ********* -->
<!-- ********* PANEL MEMBERSHIP ********* -->
<div class="features-1" id="panelMembership">
<div class="row">
<div class="col-md-8 col-md-offset-2">
<h2 class="title">Panel Membership</h2>
<h5 class="description">Capability Wise Pty Ltd is a preferred supplier to the Australian Government and is on the following panels:</h5>
</div>
</div>
<div class="row">
<div class="col-md-4">
...
<h4 class="info-title">Digital Transformation Agency - Digital Marketplace</h4>
<p>The Marketplace offers buyers different types of sourcing pathways for different types of procurement needs.</p>
<p><a href="https://marketplace.service.gov.au/">View the Marketplace</a></p>
</div>
</div>
<div class="col-md-4">
<div class="info">
...
<h4 class="info-title">Department of Infrastructure and Regional Development - IT Services Panel</h4>
<p>The IT Services Panel has been established for the provision of IT contract personnel on an as-required basis to deliver IT Services and/or specialist services through the engagement of an organisation to conduct specific activities in a number of categories of service.</p>
<p><a href="https://www.tenders.gov.au/?event=public.SON.view&SONUUID=408E3736-CC48-CE52-F89115D7E0C50EF4">AusTender: SON3403954</a></p>
</div>
</div>
<div class="col-md-4">
<div class="info">
...
<h4 class="info-title">Your preferred supplier list..</h4>
<p>If you have a preferred supplier list then make us aware and we can apply for inclusion.</p>
</div>
</div>
</div>
</div>
...
<form role="form" action="mailto:sales@capabilitywise.com.au?subject=WebsiteEquiry" enctype="text/plain" id="contact-form" method="post">
